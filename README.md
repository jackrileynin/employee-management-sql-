...
Because this application won’t be deployed, you’ll also need to create a walkthrough video that demonstrates its functionality and all of the following acceptance criteria being met. You’ll need to submit a link to the video and add it to the README ew all roles, view all employees, add a department, aof your project.
...
THEN I am presented with the following options: view all departments, vidd a role, add an employee, and update an employee role
